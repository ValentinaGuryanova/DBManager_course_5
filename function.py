...
def get_data_employers(url):
    """Функция возвращает список работодателей у которых открытых вакансий > 10 """
...
def get_vacancies(data: list):
    """Функция возвращает список данных о вакансиях по отдельному работодателю"""
